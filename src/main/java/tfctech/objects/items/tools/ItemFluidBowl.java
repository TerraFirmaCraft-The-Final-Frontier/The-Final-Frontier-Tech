...
public class ItemFluidBowl extends ItemPottery
{
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        if (cap != null)
        {
            ...
            if (fluidStack != null)
            {
                ...
                tooltip.add((new TextComponentTranslation("tooltip.tfctech.tools.fluid_bowl.fluid", fluidAmount, fluidname)).getFormattedText());
            }
        }
    ...
    public String getItemStackDisplayName(@Nonnull ItemStack stack)
    {
        ...
        if (cap != null)
        {
            ...
            {
                String fluidname = fluidStack.getLocalizedName();
                return (new TextComponentTranslation("item.tfctech.tools.fluid_bowl.filled", fluidname)).getFormattedText();
            }
        }
